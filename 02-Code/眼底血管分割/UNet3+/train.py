...
from model_unet3plus import *

# 定义设备 gpu/cpu
device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')

# 设置权重地址
weight_path = 'parameters/unet3plus.pth'

# 本机路径
# data_path = r'D:\Document\眼底图像血管分割\Datasets\splited_image_128'
# data_path = r'D:\Document\眼底图像血管分割\Datasets\DRIVE\training'
# 实验室机器路径
# data_path = r'D:\zlr_test\Datasets\splited_image_128'
data_path = r'D:\zlr_test\Datasets\DRIVE\training'
...
if __name__ == '__main__':
    ...
    while True:
        ...
        for i, (image, manual) in enumerate(data_loader):
            ...
            # 将拼接后的图片保存到save_path
            # save_image(img_compare, f'{save_path}/epoch{epoch}/{i}.png')
