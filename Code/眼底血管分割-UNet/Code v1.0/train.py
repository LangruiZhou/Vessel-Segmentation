...
# 设置权重地址
weight_path = 'parameters/unet.pth'
# 数据集地址
data_path = '/Users/larry/Documents/GitHub/LongRoad/医学图像分割/眼底血管分割/DataSets/DRIVE/training/'
# 训练效果图片保存路径
...
if __name__ == '__main__':
    ...
    if os.path.exists(weight_path):
        ...
        print('Weight-load end in failure!')
    ...
    while True:
        ...
        for i, (image, manual) in enumerate(data_loader):
            ...
            img = torch.stack([_image, _manual, _out_image], dim=0)   # 将3张图片拼接
            save_image(img, f'{save_path}/i.png')  # 将拼接后的图片保存到save_path
