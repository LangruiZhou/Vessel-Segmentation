...
if __name__ == '__main__':
    # 本机路径
    # path = r'D:\Document\眼底图像血管分割\Datasets\splited_image_128'
    # path = r'D:\Document\眼底图像血管分割\Datasets\DRIVE\training'
    # 实验室机器路径
    path = r'D:\zlr_test\Datasets\splited_image_128'
    # path = r'D:\zlr_test\Datasets\DRIVE\training'
